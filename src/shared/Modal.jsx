		...
		>
			{isLoaderOpen ? (
				<>
					...
					<p className="font-Poppins text-[#bc343e] font-semibold py-6 tracking-widest first-letter:capitalize">
				...
				>
					...
					<div className="flex justify-center items-center flex-col">
						...
						<p className="text-xl font-Poppins capitalize opacity-70">
							Pleas try with different name
						</p>
						<button
